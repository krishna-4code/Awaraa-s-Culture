  ...
  return (
    <footer className="w-full bg-bright-ink text-white py-16 px-6 font-sans border-t-4 border-bright-amber">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-10">
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-3 font-sans text-xs uppercase font-bold tracking-wider text-gray-300">
          ...
          <Link href="/shipping" className="hover:text-bright-sun transition-colors">
            Shipping
          </Link>
          <Link href="/returns" className="hover:text-bright-sun transition-colors">
            Returns
          </Link>
          ...
          <a
            ...
            className="hover:text-bright-sun transition-colors text-bright-sun"
          >
