...
const FALLBACK_PRODUCTS = [
  ...
  },
  {
    ...
    desc: "Low-profile street silhouette crafted for NCR pavement and daily hustle.",
    price: "2,999",
  ...
  },
  {
    ...
    desc: "High-top stability with breathable canvas upper and padded ankle collar.",
    price: "3,299",
    image: "https://images.unsplash.com/photo-1560769629-975ec94e6a86?auto=format&fit=crop&w=800&q=80",
    badgeColor: "bg-bright-coral text-white",
  },
  ...
  const displayProducts = initialProducts && initialProducts.length > 0
    ? initialProducts.map((p, idx) => {
        ...
        return {
          ...
          image: p.images?.[0]?.url || "https://images.unsplash.com/photo-1549298916-b41d501d3772?auto=format&fit=crop&w=800&q=80",
